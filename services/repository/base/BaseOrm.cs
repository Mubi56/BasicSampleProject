...
namespace Paradigm.Service.Repository
{
    ...
    public static partial class BaseOrm
    {
        ...
        public static IEnumerable<T> FromSql<T>(this IDbConnection connection, string query, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        //This allows use of the DataAnnotations property in the model and have the DapperOrm engine just figure it out without a reference
    ...
    /// Custom for Dapper.DapperOrm to exclude a property from Select methods
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    ...
    /// Custom for Dapper.DapperOrm to exclude a property from Insert methods
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    ...
    /// Custom for Dapper.DapperOrm to exclude a property from Update methods
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
